                  ...
                  <div className="space-y-8">
                    <div>
                      <div className="flex items-center mb-6">
                        ...
                        <h3 className="text-lg sm:text-xl font-bold text-gray-900">Notification Preferences</h3>
                      </div>
                      <div className="space-y-4">
                        {[
            ...
            <div className="mt-6 bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-4 sm:p-6 bg-red-50">
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all duration-200 text-sm font-semibold">
