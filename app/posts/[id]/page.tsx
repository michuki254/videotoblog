...
export default function BlogPostPage() {
  ...
  // Page tracking
  const { trackConversion } = usePageTracking(post?._id)
      ...
      <div className="lg:pl-72">
        ...
        <div className="relative bg-indigo-600 text-white">
          ...
          <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            <nav className="flex items-center space-x-1 text-xs sm:text-sm text-white/80 mb-2 sm:mb-3">
            ...
            <h1 className="text-base sm:text-xl md:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 leading-tight line-clamp-2">{post?.title}</h1>
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-[10px] sm:text-xs">
              <div className="flex items-center gap-1">
                ...
                <span className="hidden sm:inline">{post && formatDate(post.createdAt)}</span>
                <span className="sm:hidden">{post && new Date(post.createdAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</span>
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <span>{post?.wordCount > 999 ? `${(post.wordCount/1000).toFixed(0)}k` : post?.wordCount} words</span>
                <span className="text-white/60">•</span>
                <span>{Math.ceil((post?.wordCount || 0) / 250)} min</span>
              </div>
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
                      ...
                      <button
                        ...
                        className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-xs sm:text-sm rounded-lg shadow hover:shadow-md transition-all duration-200"
                      >
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <a
                        ...
                        className="flex flex-col items-center justify-center p-2 sm:p-3 bg-red-50 hover:bg-red-100 text-red-700 rounded-lg transition-all duration-200 group"
                      >
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 mb-0.5 sm:mb-1 group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center p-2 sm:p-3 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg transition-all duration-200 group"
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center p-2 sm:p-3 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-lg transition-all duration-200 group"
                      >
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 mb-0.5 sm:mb-1 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <article className="prose prose-lg max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-a:text-[#FF385C] prose-strong:text-gray-900 prose-ul:text-gray-700 prose-ol:text-gray-700 prose-blockquote:border-[#FF385C] prose-code:text-[#FF385C] prose-pre:bg-gray-100">
                    <ReactMarkdown
                      components={{
                        ...
                        ol: ({ children }) => (
                          <ol className="list-none pl-0 mb-6 space-y-2 counter-reset-list">
                            {children}
                          </ol>
                        ),
                        li: ({ children, ordered }) => (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-white rounded-lg p-3 shadow-sm">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-lg font-bold text-gray-900">{Math.ceil(post.wordCount / 200)}</span>
                        </div>
                      ...
                      <div className="bg-white rounded-lg p-3 shadow-sm">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-lg font-bold text-gray-900">{post.wordCount.toLocaleString()}</span>
                        </div>
                      ...
                      <div className="bg-white rounded-lg p-3 shadow-sm">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-lg font-bold text-gray-900 capitalize">{post.detailLevel[0]}</span>
                        </div>
                        <span className="text-xs text-gray-600">{post.detailLevel} Detail</span>
                      </div>
                    </div>
