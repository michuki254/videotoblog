    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="bg-white text-[#FF385C] px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center justify-center shadow-lg"
              >
              ...
              <Link
                href="/pricing"
                className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-[#FF385C] transition-colors inline-flex items-center justify-center"
              >
                View Our Plans
              </Link>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="text-center">
            <div className="bg-[#00A699]/10 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-md">
              <CurrencyDollarIcon className="h-8 w-8 text-[#00A699]" />
            </div>
          ...
          <div className="text-center">
            <div className="bg-[#FF385C]/10 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-md">
              <UsersIcon className="h-8 w-8 text-[#FF385C]" />
            </div>
          ...
          <div className="text-center">
            <div className="bg-[#FC642D]/10 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-md">
              <ChartBarIcon className="h-8 w-8 text-[#FC642D]" />
            </div>
          ...
          <div className="text-center">
            <div className="bg-[#484848]/10 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center shadow-md">
              <ShareIcon className="h-8 w-8 text-[#484848]" />
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 shadow-md rounded-lg">
              ...
              <p className="text-3xl font-bold text-[#00A699] mb-2">$3.00</p>
              <p className="text-gray-600">per referral</p>
              <p className="text-sm text-gray-500 mt-2">30% of $9.99/month</p>
            </div>
            <div className="text-center p-6 shadow-xl rounded-lg bg-[#FF385C]/10">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Pro Plan</h3>
              <p className="text-3xl font-bold text-[#FF385C] mb-2">$9.00</p>
              <p className="text-gray-600">per referral</p>
              <p className="text-sm text-gray-500 mt-2">30% of $29.99/month</p>
              <span className="inline-block bg-[#FF385C] text-white text-xs px-2 py-1 rounded-full mt-2 shadow-sm">Most Popular</span>
            </div>
            <div className="text-center p-6 shadow-md rounded-lg">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Enterprise Plan</h3>
              <p className="text-3xl font-bold text-[#FC642D] mb-2">$30.00</p>
              <p className="text-gray-600">per referral</p>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-[#FF385C] text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-md">1</div>
            ...
            <div className="text-center">
              <div className="bg-[#FF385C] text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-md">2</div>
            ...
            <div className="text-center">
              <div className="bg-[#FF385C] text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold mx-auto mb-4 shadow-md">3</div>
        ...
        {/* Perfect For */}
        <div className="bg-[#FAFAFA] rounded-lg p-8 mb-16 shadow-sm">
        ...
        <div className="text-center bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#FF385C] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#E0314F] transition-colors inline-flex items-center justify-center shadow-md"
            >
              Join Affiliate Program
              <ArrowTopRightOnSquareIcon className="h-5 w-5 ml-2" />
            </a>
            <Link
              href="/contact"
              className="shadow-sm text-gray-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors"
            >
              Contact Us
            </Link>
          </div>
          <p className="text-sm text-gray-500 mt-4">
            Questions? Email us at <a href="mailto:affiliates@videotoblog.ai" className="text-[#FF385C] hover:underline">affiliates@videotoblog.ai</a>
          </p>
        </div>
      </div>
    </div>
