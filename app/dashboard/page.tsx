          ...
          <div className="px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 max-w-full overflow-x-hidden">
            ...
            <div className="mb-3 sm:mb-4 md:mb-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
                ...
                <Link
                  href="/convert"
                  className="w-full sm:w-auto inline-flex items-center justify-center px-3 sm:px-4 py-2 bg-[#FF385C] hover:bg-[#E0314F] text-white font-medium rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 text-sm"
                >
            ...
            <div className="grid grid-cols-4 gap-1.5 sm:gap-2 mb-3 sm:mb-4">
              {/* Total Posts */}
              <div className="bg-white rounded-xl shadow-sm p-2 sm:p-2.5">
            ...
            <div className="bg-white rounded-xl shadow-md p-2 sm:p-3 mb-3">
              <div className="flex items-center gap-2 overflow-x-auto">
                <Link
                  href="/convert"
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FF385C]/10 hover:bg-[#FF385C]/20 rounded-md transition-colors whitespace-nowrap"
                >
                  <svg className="w-3.5 h-3.5 text-[#FF385C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4v16M17 4v16M3 8h4m10 0h4M3 16h4m10 0h4" />
                  </svg>
                  <span className="text-xs font-medium text-[#484848]">Convert</span>
                </Link>

                <button
                  onClick={() => setShowCreateFolder(true)}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-[#FC642D]/10 hover:bg-[#FC642D]/20 rounded-md transition-colors whitespace-nowrap"
                >
                  <svg className="w-3.5 h-3.5 text-[#FC642D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
                  <span className="text-xs font-medium text-[#484848]">New Folder</span>
                </button>

                {draftsCount > 0 && (
                  <button
                    onClick={() => setFilter('draft')}
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#00A699]/10 hover:bg-[#00A699]/20 rounded-md transition-colors whitespace-nowrap"
                  >
                    <svg className="w-3.5 h-3.5 text-[#00A699]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                    </svg>
                    <span className="text-xs font-medium text-[#484848]">Drafts ({draftsCount})</span>
                  </button>
                )}
              </div>
            </div>
            ...
            {folders.length > 0 && (
              <div className="bg-white rounded-xl shadow-md p-2 sm:p-3 mb-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() => setShowCreateFolder(true)}
                    className="text-[10px] text-[#FF385C] hover:text-[#E0314F] font-medium"
                  >
                    + Add
                  </button>
                </div>
                      ...
                      {(['all', 'published', 'draft'] as const).map((filterOption) => (
                        <button
                          ...
                          className={`flex-1 sm:flex-initial px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium ${
                            ...
                            filter === filterOption ? 'border-[#FF385C]' : 'border-gray-300'
                          }`}
                        >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#FF385C] text-white rounded-lg font-medium hover:bg-[#E0314F] disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-md"
                >
                  Create Folder
                </button>
              </div>
